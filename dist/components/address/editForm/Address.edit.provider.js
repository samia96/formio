...
exports.default = [
    {
        ...
        data: {
            custom: function () {
                return lodash_1.default.values(Formio_1.Formio.Providers.getProviders('address')).sort().map(function (provider) { return ({
...
//# sourceMappingURL=Address.edit.provider.js.map