...
var EditFormUtils = {
    sortAndFilterComponents: function (components) {
        return lodash_1.default.filter(lodash_1.default.sortBy(components, 'weight'), function (item) { return !item.ignore; });
    },
    unifyComponents: function (objValue, srcValue) {
        if (objValue.key && srcValue.key) {
            ...
            if (objValue.key === srcValue.key) {
                ...
                lodash_1.default.each(objValue, function (value, prop) {
                    if (objValue.overrideEditForm || !srcValue.hasOwnProperty(prop)) {
                        srcValue[prop] = value;
                    }
                });
                lodash_1.default.each(srcValue, function (value, prop) {
